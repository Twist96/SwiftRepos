...
public final class SearchRepositoryQuery: GraphQLQuery {
  ...
  public init(query: String, type: SearchType, first: Int? = nil, after: String? = nil) {
    self.query = query
    self.type = type
    self.first = first
    self.after = after
    ...
    public struct Search: GraphQLSelectionSet {
      ...
      public struct Edge: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeRepository(id: GraphQLID, name: String, owner: AsRepository.Owner, stargazerCount: Int, forkCount: Int) -> Node {
            return Node(unsafeResultMap: ["__typename": "Repository", "id": id, "name": name, "owner": owner.resultMap, "stargazerCount": stargazerCount, "forkCount": forkCount])
          }
          ...
          public struct AsRepository: GraphQLSelectionSet {
            ...
            public init(id: GraphQLID, name: String, owner: Owner, stargazerCount: Int, forkCount: Int) {
              self.init(unsafeResultMap: ["__typename": "Repository", "id": id, "name": name, "owner": owner.resultMap, "stargazerCount": stargazerCount, "forkCount": forkCount])
            }
